...
| `daily_usage_logs` | ~182,000 | Clustered by `account_id`. Time-partitioning on `date` is off by default in sandbox and flag-gated for prod — see *Sandbox vs. prod* below. |
